 ...
 */
public class Box extends VGeometry3D {

    private double scale;
    private static VTriangleArray geometry;

    static {
        OBJ2Geometry loader = new OBJ2Geometry();
        try {
            geometry = loader.loadAsVTriangleArray(
                    Box.class.getResourceAsStream(
                    "/edu/gcsc/vrl/densityvis/resources/box.obj"));
    ...
    public Box(double x, double y, double z, double scale) {
        init(x, y, z, scale, null);
    }

    public Box(double x, double y, double z, double scale, Color c) {
        init(x, y, z, scale, c);
    }
    ...
    private void init(double x, double y, double z, double scale, Color c) {
        ...
        setGeometry(new VTriangleArray(geometry.getTriangleArray()));
